...
export default function ServicePageTemplate({
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8">Key Benefits</h2>
              <div className="space-y-4">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Related Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {relatedServices.map((service, index) => {
              const ServiceIcon = service.icon;
              return (
                <Link key={index} href={service.href}>
                  <Card className="border-2 hover:border-red-600 transition-all duration-300 hover:shadow-lg cursor-pointer h-full">
                    <CardHeader>
                      <div className="w-14 h-14 bg-red-100 rounded-lg flex items-center justify-center mb-4">
                        <ServiceIcon className="h-7 w-7 text-red-600" />
                      </div>
